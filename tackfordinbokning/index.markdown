...
<div class="thanks" style="padding: 90px 0px 0px;">
	<h2 style="text-align: center; padding-bottom: 40px;">Tack för din bokning!</h2>
		...
		<br>
		<br>
		Skriv gärna också om du andra särkilda önskemål för vad du vill göra, så förbereder jag hur jag kan hjälpa dig bäst möjligt. 
		<br>
		<br>
		...
		<br>
		<br>
		Jag ser fram emot vår pianolektion! 
		<br>
		<br>
		Hälsningar Petter
</div>
